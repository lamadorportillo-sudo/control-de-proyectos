...
(()=>{
  ...
  @media(max-width:620px){.lc-phase-head{grid-template-columns:34px 1fr}.lc-phase-pct{grid-column:2}.lc-item{grid-template-columns:24px 1fr}.lc-date,.lc-note{grid-column:2/-1}.lc-footer{display:block}.lc-footer b{display:block;margin-top:4px}}
  `;
