...
function css(){
 ...
 .ccc-page{display:grid;gap:13px}.ccc-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-end}.ccc-head h2{margin:3px 0 4px;font-size:25px;letter-spacing:-.025em;color:#172231}.ccc-head p{margin:0;color:#74869a;font-size:11px}.ccc-eyebrow{font-size:9px;font-weight:850;letter-spacing:.12em;color:#1769c2}.ccc-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:9px}.ccc-kpi{padding:15px 16px;border:1px solid #dfe7f0;border-radius:12px;background:#fff;box-shadow:0 8px 28px rgba(24,48,75,.055)}.ccc-kpi small{display:block;color:#75879a;font-size:9px}.ccc-kpi strong{display:block;margin-top:6px;color:#162b40;font-size:20px}.ccc-tools{display:flex;gap:8px;align-items:center;padding:10px;border:1px solid #dfe7f0;border-radius:12px;background:#fff}.ccc-tools input{flex:1;min-width:0}.ccc-table{overflow:auto;border:1px solid #dfe7f0;border-radius:12px;background:#fff;box-shadow:0 8px 28px rgba(24,48,75,.045)}.ccc-row{display:grid;grid-template-columns:minmax(170px,.8fr) minmax(260px,1.5fr) minmax(155px,.8fr) 135px 120px 112px;gap:10px;align-items:center;padding:11px 13px;border-bottom:1px solid #edf1f5}.ccc-row:last-child{border-bottom:0}.ccc-row.head{position:sticky;top:0;z-index:2;background:#f4f7fa;color:#64788c;font-size:8px;font-weight:850;text-transform:uppercase;letter-spacing:.04em}.ccc-row:not(.head):hover{background:#f8fbfe}.ccc-main b{display:block;color:#1a3148;font-size:10px}.ccc-main small,.ccc-cell small{display:block;margin-top:2px;color:#7a8c9e;font-size:8px}.ccc-cell b{color:#29445e;font-size:10px}.ccc-progress{display:flex;align-items:center;gap:7px}.ccc-track{height:6px;flex:1;border-radius:99px;background:#e7eef5;overflow:hidden}.ccc-track i{display:block;height:100%;border-radius:inherit;background:linear-gradient(90deg,#1769c2,#43a1ef)}.ccc-empty{padding:34px;text-align:center;color:#788a9d}.ccc-nav-btn{white-space:nowrap}
 @media(max-width:1050px){.ccc-row{grid-template-columns:minmax(150px,.8fr) minmax(220px,1.5fr) 130px 105px 100px}.ccc-row>*:nth-child(3){display:none}.ccc-kpis{grid-template-columns:1fr 1fr}}
 @media(max-width:700px){.ccc-head{display:block}.ccc-kpis{grid-template-columns:1fr 1fr}.ccc-row.head{display:none}.ccc-row{grid-template-columns:1fr auto;gap:6px 10px}.ccc-row>*{display:block!important}.ccc-row .ccc-cell{grid-column:1}.ccc-row .ccc-action{grid-column:2;grid-row:1/5;align-self:center}.ccc-tools{display:block}.ccc-tools input{width:100%}}
