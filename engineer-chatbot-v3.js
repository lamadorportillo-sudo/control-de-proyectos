...
function mount(){
  ...
  const launch=document.createElement('button');launch.id='ccEngineerChatLaunch';launch.className='cc-eng-chat-launch';launch.title='Hablar con Halu';launch.setAttribute('aria-label','Hablar con Halu');launch.innerHTML='<span class="cc-eng-avatar-frame cc-halu-walker"><img class="cc-halu-layer cc-halu-torso" src="halu-engineer-cutout-v4.png" alt="Halu, ingeniero civil de apoyo"><img class="cc-halu-layer cc-halu-leg cc-halu-leg-left" src="halu-engineer-cutout-v4.png" alt=""><img class="cc-halu-layer cc-halu-leg cc-halu-leg-right" src="halu-engineer-cutout-v4.png" alt=""></span><span class="dot"></span>';
