...
function css(){
  ...
  .cc-eng-chat-launch{position:fixed;right:20px;bottom:20px;z-index:120;width:62px;height:62px;border:2px solid #38bdf8;border-radius:50%;padding:0;overflow:hidden;background:#07111d;box-shadow:0 14px 38px rgba(0,0,0,.45),0 0 0 5px rgba(56,189,248,.10);cursor:pointer}.cc-eng-avatar-frame{position:relative;display:block;flex:0 0 auto;overflow:hidden;border-radius:50%;background:#e8edf2}.cc-eng-chat-launch .cc-eng-avatar-frame{width:100%;height:100%}.cc-eng-avatar-frame img{position:absolute;width:365%;height:365%;max-width:none;left:-133%;top:-2%;object-fit:contain}.cc-eng-chat-launch .dot{position:absolute;right:2px;bottom:3px;width:13px;height:13px;border:2px solid #07111d;border-radius:50%;background:#22c55e}
