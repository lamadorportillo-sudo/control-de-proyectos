...
export const InicioView: React.FC<InicioViewProps> = ({
  ...
  const quickActions = [
    ...
    },
    {
      ...
      desc: 'Formalizar o vincular contrato',
      icon: FilePlus2,
    ...
    },
    {
      ...
      desc: 'Generadores y deducciones',
      icon: Receipt,
    ...
    },
    {
      ...
      desc: 'Emisión y liquidación bancaria',
      icon: CreditCard,
    ...
    },
    {
      ...
      desc: 'Evidencia técnica y actas',
      icon: UploadCloud,
    ...
    {
      id: 'qa-deficiency',
      label: 'Registrar deficiencia',
      desc: 'No conformidad en obra',
      icon: AlertOctagon,
