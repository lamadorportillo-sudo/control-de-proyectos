...
const dashboardCss=document.createElement('link');dashboardCss.rel='stylesheet';dashboardCss.href='dashboard-simplified-v4.css?v=20260901-dash4';document.head.appendChild(dashboardCss);
...
const dashboardJs=document.createElement('script');dashboardJs.src='dashboard-simplified-v4.js?v=20260901-dash4';dashboardJs.defer=true;document.head.appendChild(dashboardJs);
})();
