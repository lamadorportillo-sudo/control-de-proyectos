...
@media(max-width:900px){.service-strip{grid-template-columns:repeat(2,1fr)!important}.hero-control-contractual{min-height:280px;padding:30px}.topbar{position:static!important}.service-project{grid-template-columns:1fr auto}.service-project-meta{grid-column:1/-1;grid-row:2}}
@media(max-width:620px){.shell{padding:10px 12px 28px!important}.topbar{border-radius:14px!important}.hero-control-contractual{min-height:350px;padding:25px 20px;border-radius:16px}.hero-copy p{font-size:14px}.service-strip{grid-template-columns:1fr 1fr!important;gap:8px}.service-tile{padding:13px 8px}.project-grid{grid-template-columns:1fr!important}.service-picker-bg{padding:7px}.service-picker{max-height:94vh;border-radius:15px}.service-picker-head,.service-picker-tools,.service-picker-list{padding-left:13px;padding-right:13px}.service-project{grid-template-columns:1fr}.service-project-meta{grid-column:auto;grid-row:auto}.service-project .btn{width:100%}}
  `;
