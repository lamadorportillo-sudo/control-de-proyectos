...
assert.match(contrast,/CONTRASTE DOCUMENTAL V1/,'debe existir la corrección contextual del expediente documental');
assert.match(contrast,/\.cc2-archive/,'la corrección debe quedar limitada al repositorio documental');
...
assert.equal(supplementalModules[contrastAt][1],'20260905-contractdoccontrast1');

console.log('contract-ui-invariants: monto vigente calculado y expediente documental con contraste contextual');