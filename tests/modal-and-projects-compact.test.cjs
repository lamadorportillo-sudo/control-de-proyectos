...
test('las versiones publicadas conservan una sola autoridad de carga',()=>{
  ...
  assert.match(serviceWorker,/const CACHE='cc-static-v1-20260914-master1'/);
  ...
  assert.match(runtime,/service-worker-v1\.js\?v=20260914-sw-master1/);
  assert.match(stabilizer,/portal-web-v2\.js\?v=20260914-master1/);
  assert.match(stabilizer,/dashboard-simplified-v4\.js\?v=20260915-visible-redesign8/);
