...
assert.match(src,/COORDINADOR DE RENDIMIENTO DEL DOM V6/,'debe mantenerse la versión estable con deduplicación exacta de assets');
...
console.log('performance-runtime estable: deduplicación, versiones, orden y caché validados');
