...
assert.match(source,/board\?\.querySelector\('#zordonProjectSearch,\[data-zordon-input\],#projectSearch'\)/,'el puente debe priorizar el campo real de ZORDON y conservar el buscador histórico solo como fallback');
