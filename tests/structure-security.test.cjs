...
assert(html.includes('engineer-chatbot-v3.js?v=20260823-ai4'),'La versión publicada de Halu no coincide.');
...
assert(html.includes('feature-lazy-loader-v1.js?v=20260823-lazy2'),'La carga progresiva debe estar activa.');
...
assert(lazyLoader.includes('cost-program-v1.js?v=20260823-costs5'),'El Programa de costos debe estar disponible bajo demanda.');
