...
assert.match(guard,/GUARDIA FINAL DE CONTRASTE V4/,'debe existir la guardia final WCAG V4');
...
assert.equal(supplementalModules[guardAt][1],'20260904-contrast-final4','la versión de la guardia final debe quedar fijada en el manifiesto');

console.log('ui-contrast-final-guard: Inicio, transparencia, normativa, lectura operativa y ciclo de vida protegidos antes del cierre técnico');
