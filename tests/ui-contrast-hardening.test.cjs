...
assert.match(modules,/ui-contrast-hardening-v1\.js\?v=20260831-contrast3/,'debe forzarse la versión publicada del endurecimiento V3');

console.log('ui-contrast-hardening: navegación, invitado, fondos sólidos, KPI, acciones y presupuesto verificados');
